...
public final class MainView extends View {
    ...
    private final static ImmutableList<DeviceType> deviceTypes = ImmutableList.copyOf(DeviceType.values());

    private final static ImmutableList<DeviceOs> deviceOses = ImmutableList.copyOf(DeviceOs.values());

    private final static ImmutableList<MobileBrowser> mobileBrowsers = ImmutableList.copyOf(MobileBrowser.values());

    private final static ImmutableList<InputDevice> inputDevices = ImmutableList.copyOf(InputDevice.values());

    public MainView(Optional<String> userAgent, Optional<? extends DeviceProfile> deviceProfile) {
        super(TEMPLATE_NAME);
